...
from basicsr.losses import build_loss,l1_loss_type,l1_loss_type_DWA,l1_loss_type_DWA_T_10,l1_loss_type_DWA_T_1,l1_loss_type_DWA_T_0_1,l1_loss_type_LossWA_T_1,l1_loss_type_LossWA_T_10_with_ema
...
##############################################################################################
# 该文件用于训练原始SRResnet/Swim等，不支持MiOIR AP/EP操作
# loss为原始7type平均，不支持dwa_loss,loss_weight等操作

##############################################################################################


@MODEL_REGISTRY.register()
class IRModel(BaseModel):   #纯净原版
